<template>
  <div ref="designDisplay" class="design-display">
    <div class="container">
      <div data-poster-url="@/assets/display video-poster-00001.jpg" data-video-urls="@/assets/display-video-transcode.mp4,@/assets/display-video-transcode.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" class="video display-video w-background-video w-background-video-atom">
        <video autoplay style="background-image:url(&quot;@/assets/display video-poster-00001.jpg&quot;)" muted playsinline data-wf-ignore="true" data-object-fit="cover">
...
export default {
  ...
  setup() {
    ...
    return {
      designDisplay, animateTo, animateFromTo,
    };
  },
  mounted() {
